...
program
  ...
  .option("--step-limit <number>", "Maximum model calls; 0 disables", "0")
  .option("--cost-limit <number>", "Maximum tracked cost; 0 disables", "0")
  .option("--wall-time-limit-seconds <number>", "Maximum wall time; 0 disables", "0")
  ...
  .option("--setup-command <command>", "Command to run before the agent starts")
  .option("--verify-command <command>", "Command the agent should use to verify its work")
